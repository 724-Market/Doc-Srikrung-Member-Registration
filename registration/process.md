...
<figure><img src="../.gitbook/assets/summary-information.png" edit-bankalt=""><figcaption><p>สรุปข้อมูลทั้งหมดของผู้สมัคร</p></figcaption></figure>

ขั้นตอนนี้จะเป็นการสรุปข้อมูลทั้งหมดของผู้สมัคร เพื่อให้ผู้สมัครได้ทำการตรวจสอบความถูกต้องของข้อมูล โดยข้อมูลจะถูกแบ่งออกตามหัวข้อต่างๆ หากผู้สมัครจะทำการแก้ไขข้อมูลใด ให้กดปุ่ม **"แก้ไขข้อมูล"** ภายใต้หัวข้อนั้นๆ ระบบจะพาไปยังส่วนของการแก้ไข

ตัวอย่างหน้าจอกรณีที่จะทำการแก้ไขข้อมูลธนาคาร

<figure><img src="../.gitbook/assets/edit-bank.png" alt=""><figcaption><p>กดปุ่มแก้ไขข้อมูล หากต้องการแก้ไขข้อมูลในหัวข้อข้อมูลธนาคาร</p></figcaption></figure>

สำหรับรูปที่ใช้ในการยืนยันตัวตน (E-KYC) เพื่อเพิ่มความปลอดภัยให้กับข้อมูลของผู้สมัคร ระบบจะคาดลายน้ำให้โดยอัตโนมัติ

กรณีที่ผลการยืนยันตัวตน**สำเร็จ**

<figure><img src="../.gitbook/assets/ekyc-pass.png" alt=""><figcaption><p>การยืนยันตัวตนสำเร็จ</p></figcaption></figure>

กรณีที่ผลการยืนยันตัวตน**ไม่ผ่านเกณฑ์** เจ้าหน้าที่จะพิจารณาและอาจติดต่อไปยังผู้สมัครอีกครั้ง ตามข้อมูลที่ผู้สมัครได้ให้ไว้

<figure><img src="../.gitbook/assets/ekyc-fail.png" alt=""><figcaption><p>การยืนยันตัวตนไม่ผ่านเกณฑ์</p></figcaption></figure>

และหากผู้สมัครตรวจสอบข้อมูลเรียบร้อยแล้ว ให้กด **"ยืนยันข้อมูลและชำระเงิน"** เพื่อดำเนินการต่อในขั้นตอนถัดไป
...
หลังจากที่ทำการชำระเงินเสร็จสมบูรณ์แล้ว ระบบจะแสดงหน้าจอยืนยันการชำระเงิน พร้อมแสดงสถานะเป็น **รอการอนุมัติ** แต่หากหน้าจอยังแสดงข้อมูล QR Code อยู่ ให้กดปุ่ม **ตรวจสอบสถานะการชำระเงิน** เพื่อทำการตรวจสอบไปยังธนาคารอีกครั้ง

<figure><img src="../.gitbook/assets/thanks.png" alt=""><figcaption><p>ชำระเงินเรียบร้อย และรอการอนุมัติ</p></figcaption></figure>

ในกระบวนการถัดไป เจ้าหน้าที่จะทำการตรวจสอบข้อมูลทั้งหมด และจะแจ้งผลการสมัครสมาชิกให้ผู้สมัครทราบด้วยช่องทาง SMS ภายในเวลาไม่เกิน 1 วันทำการ
